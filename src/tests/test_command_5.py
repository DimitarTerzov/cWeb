...
tag &lt;/lang:English&gt; ČSSD and voice &lt;/lang:English&gt; perspective\n", # 40
    ...
    u'&lt;lang:Portuguese&gt;\n', # 42
    u'<Sync time="411.39"/>\n', # 43
    u"Peut-être pas en termes d'hommes mais plutôt en termes d'armes &lt;/lang: Portuguese&gt; \
ou'bou de ressources financières. Et comment va évoluer la question de l'est de \
l'Ukraine et les relations internationales tout court.\n", # 44
    u'<Sync time="411.39"/>\n',    # 45
    u'Good evening &lt;lang:Portuguese&gt; once again.\n',    # 46
    u'<Sync time="411.39"/>\n',    # 47
    u'&lt;/lang:Portuguese&gt;\n',    # 48
    u'</Turn>\n', # 49
]
